...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<WeatherApiService>(onMissingStub: OnMissingStub.returnDefault),
...
void registerServices() {
  ...
  getAndRegisterWeatherApiService();
...
MockWeatherApiService getAndRegisterWeatherApiService() {
  _removeRegistrationIfExists<WeatherApiService>();
  final service = MockWeatherApiService();
  locator.registerSingleton<WeatherApiService>(service);
  return service;
}
